...
RECENCY RULE: A live ATS listing proves that roles are currently listed, not that they were posted recently. Never call an old cluster a "hiring push," "hiring surge," "moving fast," or current velocity. If the newest posting date is more than 30 days old, say the roles remain listed but posting recency is stale; use "watch" unless another verified fact supplies a genuinely current trigger.
